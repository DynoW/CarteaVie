...
export const Hero = () => {
  ...
  return (
    <div id="top" className="relative px-12 md:px-24 w-full h-screen flex flex-col py-6 pt-62 md:pt-0 md:justify-center bg-[url('/bg2.jpg')] bg-no-repeat bg-cover md:bg-fixed bg-scroll bg-bottom">
